...
| K | Employees - Companies House | **Added 2026-09-17, and now the anchor headcount signal alongside J.** The "average number of employees" note in the company's filed accounts (usually Note 3-5, sometimes higher-numbered — search the PDF for "average number of employees" or "monthly average number of persons employed"). This is disclosed even in many micro-entity/abridged filings that omit the P&L, so it's often available even when Revenue/PBT (columns M/N) aren't. See the sizing heuristic below for how this combines with columns I and J. |
...
| N | Profit Before Tax | Same sourcing rule as Revenue, including the Notes explanation when it's a filing-type gap rather than something unfound. |
...
Revenue is rarely disclosed for small private companies, so headcount is the triage proxy — and as of 2026-09-17 there are **three** headcount signals to collect, not two: Company Size band (I), Associated Members on LinkedIn (J), and Employees - Companies House (K). Collect all three where you can; don't stop once one of them looks decisive.

**Use whichever of the three gives the largest figure as the working headcount for screening — and specifically don't second-guess a larger Companies House number** (Daniel, 2026-09-17). The reasoning: some of these companies use a material number of contractors, and it's genuinely unclear from LinkedIn alone whether contractors are counted as staff. When the Companies House "average employees" figure comes out *larger* than what LinkedIn shows, that's evidence Companies House is capturing a fuller picture (contractors included) rather than a discrepancy to explain away. This isn't a one-directional rule, though — Companies House isn't always the larger number. On the first real batch this was tested against: Thermaright's LinkedIn Associated Members (9) was larger than its Companies House figure (3); Ability Power's Companies House figure (15) was more than 5x its LinkedIn Associated Members (3). Take the largest of the three every time, and note in Sources/Notes which figure you used and why the others were lower — don't quietly drop the smaller readings, they're still informative (e.g. a small LinkedIn presence relative to a larger Companies House headcount can itself be worth a one-line note).
