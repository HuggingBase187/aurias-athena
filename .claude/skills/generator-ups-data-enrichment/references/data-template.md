...
| J | Associated Members on LinkedIn | **Essential, not optional (Daniel, 2026-09-17).** LinkedIn's actual member count, e.g. "72" — a real number, not a band, and the more accurate headcount signal of the two. Found on the company's LinkedIn page itself (the "X associated members" line on the About page) — actively look it up via the Claude-in-Chrome browser tool, don't leave it blank by default. Only leave it blank if you've genuinely tried and the page won't yield a number (see the sizing heuristic section below for what to do then). |
| K | Ultimate Owner | Companies House / press — the owning entity or family, distinct from the named PSC individual. |
| L | Revenue | **Companies House filed accounts or a press release/investor-relations release only** — never an estimate, LinkedIn-derived guess, or other third-party figure. Leave blank rather than guess. **If it's blank because the company filed micro-entity/abridged/total-exemption accounts (which legally omit the P&L), say so in Notes** (e.g. "Revenue/PBT not disclosed — filed abridged accounts, no P&L") — that's a structural fact about the filing, not a research gap, and it should read that way rather than as an unexplained blank. |
| M | Profit Before Tax | Same sourcing rule as Revenue, including the Notes explanation when it's a filing-type gap rather than something unfound. |
...
| P | PSC LinkedIn | **Search technique (Daniel, 2026-09-17): on LinkedIn, search the PSC's name together with the company name** (e.g. "Jane Example Sample Power Solutions") — this is the reliable way to land on the right profile rather than guessing from a bare name search. Verify the result is actually the same person (right company, plausible role) before recording it. |
| Q | PSC Email | Pattern-matched then verified where possible. **Never a generic role address** (info@, hello@, sales@, contact@, etc.) — see "Contact rules" below. Fine to leave blank if not found — lower priority than PSC LinkedIn. |
| R | PSC Phone | Pattern-matched then verified where possible. Fine to leave blank if not found — lower priority than PSC LinkedIn. |
| S | CEO / MD Name | LinkedIn/website — tracked separately from the PSC, since the CEO/MD and the registered PSC are very often different people. UK small/private companies often use "Managing Director," "Director," or "General Manager" rather than "CEO" — treat these as the same target role: whoever is actually running the business day to day. |
| T | CEO / MD LinkedIn | **Essential, not optional (Daniel, 2026-09-17) — this is the single most important contact field in the row.** Same search technique as PSC LinkedIn (name + company name). Don't leave this blank without having actually tried the search. |
| U | CEO / MD Email | Same treatment as PSC Email, **including the no-generic-address rule.** Fine to leave blank if not found — lower priority than CEO/MD LinkedIn. |
| V | CEO / MD Phone | Same treatment as PSC Phone. Fine to leave blank if not found — lower priority than CEO/MD LinkedIn. |
...
Revenue is rarely disclosed for small private companies, so use **LinkedIn headcount as the triage proxy — and Associated Members (column J) is the primary signal, not the Company Size band (column I)** (Daniel, 2026-09-17). The band is a coarse LinkedIn-assigned range; Associated Members is a real number, on the same LinkedIn company page (About section), and it's what "30-100 staff" actually means in practice. Look it up via the Claude-in-Chrome browser tool before falling back to the band alone. Companies with **30–100 staff are in scope by default** — a wide, inclusive band, not a narrow target. Only mark one out-of-scope within that band if you know otherwise with real certainty. Below ~30 is usually too small; above ~100 needs more scrutiny before ruling in or out — check Ultimate Owner (column K) before ruling out on headcount alone, since a large group-level figure can mask a right-sized subsidiary or division.

**The tie-break below is a genuine last resort, not a shortcut** — try to get the real Associated Members number first. Only when the LinkedIn band itself straddles the 30 or 100 boundary *and* you've actually tried and failed to get the exact Associated Members count (e.g. a "11-50 employees" band straddles the 30 floor, or "51-200" straddles the 100 ceiling) — **default to In-scope rather than "Needs more info"** (Daniel, 2026-09-17). This is the same inclusive instinct as the wide 30-100 band itself: a company worth a second look shouldn't get stuck in limbo just because LinkedIn's own banding is coarser than our cutoff. If a more specific disqualifier turns up alongside the ambiguous headcount (PE-owned, wrong sub-sector, etc.), that still governs the verdict as normal — this rule only breaks the tie when headcount is the *only* open question.
