...
- **Accounts Next Due - Companies House (AE)** — added 2026-09-18: while you're already on the Companies House overview page for K/M/N, also copy its own published "Accounts next due" date. Costs nothing extra, and it's what lets `generator-ups-near-misses-update` check locally whether a company needs a re-check instead of calling Companies House every month for nothing.
