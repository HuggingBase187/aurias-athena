...
- What "excellent business" means in underwriting terms beyond IRR — Aurias 2's target profile (PBT £1m–£10m mapped, sweet spot PBT £2–4m; entry multiples 6–8.5x) is known from the sector research doc, but the fuller evaluation framework isn't defined yet. Build it when the evaluation workflow gets built, not needed for this file.
